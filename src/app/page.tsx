...
export default function Home() {
  return (
    <div className = "relative  min-h-screen flex flex-col items-center overflow-hidden ml-40"> {/*defining a flex box flex col so our text, header, and image all stack on each other vertically and also moving the container for all these things to the right rigth by 36 */}
      ...
      <div className = "flex flex-col items-start"> {/*wrapping the header and text in their own flex box so I can use items start to center them left across their cross axis which in this case is the horizontal one */}
        ...
        <p className = "text-white transform mt-40 text-6xl max-w-3xl">{introductionText}</p>
      </div>
