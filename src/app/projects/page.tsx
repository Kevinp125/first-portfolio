...
export default function app() {
  ...
  const projectInfo = [
    ...
    //streamnet project
    {
      name: "StreamNet",
      description:
        "Streamnet is a streamer collaboration platform developed as a Meta capstone project alongside Meta engineers. It uses intelligent algorithms to deliver personalized recommendations, helping streamers discover collaboration partners through event sharing and smart notifications. The platform's matching system learns from user interactions to improve connections, making it easier for streamers to grow their audiences together.",
      imageSrc: "/images/projectIcons/Streamnet.png",
      imageAlt: "Streamnet website logo",
      linkRef: "https://github.com/Kevinp125/StreamNet",
      techUsed: ["Vite", "React", "Supabase", "OAuth", "Express", "Websockets", "PostgreSQL"],
    },
    ...
    //CyberSpurs
    {
      ...
      linkRef:
        "https://play.unity.com/en/games/b645f619-26f2-4bb4-875a-3b0952dbef90/cyberspurs",
      techUsed: ["Unity", "C#"],
    },
  ...
  return (
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-row justify-start pt-60 pl-12 md:p-6 md:pt-96 lg:pl-50 lg:pt-48">
        ...
        <p className="animate-fade animate-once animate-duration-[2000ms] animate-normal animate-fill-forwards text-lg max-w-2xl wrap ">
          Since I began studying computer science, I&apos;ve worked on a variety
          of projects showcasing my skills and creativity, which is all also on
          my GitHub.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 pl-7 mb-20 lg:grid-cols-2 gap-4 pt-8 lg:pl-36 lg:mb-0 auto-rows-fr">
        {" "}
        {/*Here we added auto-rows-fr to make sure if one card has a lot of tech and the height is bigger other cards match this height as well */}
        {projectInfo.map((project, i) => (
          ...
          <ProjectCard
            ...
            className="animate-fade-right animate-normal animate-fill-forwards"
            key={i}
            project={project}
          />
        ))}
