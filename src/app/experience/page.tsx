...
export default function app() {
  ...
  const experience = [
...

    {
      ...
      description: {
        paragraph:
          "***This is where description of work at this compnay goes need to fill this in after website is done",
  ...
  return (
    <div className="min-h-screen flex flex-col items-center lg:pl-44">
      {/*div so that items contained are shifted left by 44 and are centered horizontally*/}

      <div className="flex flex-col items-start pt-56 md:pt-96 lg:pt-48">
        {" "}
        {/*Another div this time so all elements inside stay in middle of page but also align with each other left. Kind of like a left-align */}
        ...
        <div className="pl-12 md:pl-0">
          ...
          <h2 className="animate-fade animate-once animate-duration-[2000ms] animate-normal animate-fill-forwards text-lg max-w-2xl wrap md:pl-0">
            My journey in tech has been shaped by amazing opportunities and
            experiences. Here&apos;s a quick glimpse at the path I&apos;ve taken
            so far.
          </h2>
        </div>
        <div className="relative w-full flex flex-row">
          {" "}
          {/*This div is so that the bamboo and the sword and card all line up side by side */}
          <div
            className="hidden md:block md:-left-14 absolute top-6 lg:-left-12 w-1/6 bg-contain h-full z-10"
            style={{ backgroundImage: "url('/images/bamboo.png')" }}
          ></div>
          <div className="ml-14 mb-16 md:translate-x-4 md:ml-0 lg:translate-x-8 lg:ml-0 lg:mb-0 w-full py-8 flex flex-col gap-10 z-20">
            ...
            {experience.map((exp, i) => (
              <ExperienceCard
                ...
                className="animate-fade-up animate-once animate-duration-[1500ms] animate-normal animate-fill-forwards"
                key={i}
                experience={exp}
              />
            ))}
